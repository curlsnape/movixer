...
function Cards({ data ,title}) {
  ...
  return (
    <div className="w-full h-full bg-[#1F1E24] py-14 flex justify-center flex-wrap gap-14">
      {data.map((c, i) => (
        ...
        >
          <img
            className="h-[40vh] w-full object-cover shadow-[8px_17px_38px_2px_rgba(0,0,0,0.5)]"
